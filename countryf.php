...
<div class="col-sm-4 col-sm-offset-1">
  <ul class="nav nav-pills">
    ...
    <li role="presentation" class="active"><a href="countryf.php">Countries</a></li>
  ...
  <div>
  <form method="post" action="countryf.php" name="content_form" id="content_form">
...
$check_country = $mysqli->query("SELECT f.id, f.first_name, f.last_name, f.wins, f.losses
                              FROM fighter AS f
